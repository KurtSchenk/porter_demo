...
function generateProfile {
    ...
    /cnab/app/tools/pac auth create --url https://orga68a4dfd.crm.dynamics.com --name "porter-creds-spn" --applicationId {PLACEHOLDER} --clientSecret "{PLACEHOLDER}" --environment $Environment --tenant $TenantId
   
    /cnab/app/tools/pac auth create --name $ProfileName --kind Admin --applicationId {PLACEHOLDER} --clientSecret "{PLACEHOLDER}" --environment $Environment --tenant $TenantId
